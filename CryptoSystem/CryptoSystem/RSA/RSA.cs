...
namespace RSA
{
    public class RSA_Ciepher
    {
        ...
        public static bool IsProbablyPrime(BigInteger number, RandomNumberGenerator rng, int certainty = 10)
        {
        ...
        public static BigInteger RandomSmallInteger(BigInteger min, BigInteger max, RandomNumberGenerator rng)
        {
